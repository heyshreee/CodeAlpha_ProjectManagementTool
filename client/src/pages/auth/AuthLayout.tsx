      ...
      <div className="w-full max-w-md">
        <div className="mb-6 flex flex-col items-center">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-lg font-bold text-slate-100">ProjectFlow</span>
          </div>
          <p className="text-sm text-slate-400">Real-time collaborative project management</p>
        </div>
        <div className="bg-surface-2/95 border border-edge rounded-xl p-5 sm:p-6 shadow-2xl shadow-black/20">
